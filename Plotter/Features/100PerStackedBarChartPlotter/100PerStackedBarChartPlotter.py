...
###
# /* 100PerStackedBarChartPlotter.py */
# 
# 
###
...
def main():
    ...
    data_sums = np.sum([list(cities_data[city]) for city in cities_data], axis=0)
    ...
    # グラフ出力
    plt.savefig("./100PerStackedBarChartPlotter.pdf", bbox_inches="tight", pad_inches=0.05)
    plt.show()
