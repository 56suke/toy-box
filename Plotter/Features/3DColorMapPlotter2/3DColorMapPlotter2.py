...
def main():
    ...
    # XY平面にカラーマップを追加 (contourfを使って2Dカラーマップ)
    ax.contourf(X, Y, Z, zdir='z', offset=zMin, cmap='turbo', alpha=0.7)
    ...
    # グラフ出力
    plt.savefig("./3DColorMapPlotter2.pdf", bbox_inches="tight", pad_inches=0.05)
    plt.show()
